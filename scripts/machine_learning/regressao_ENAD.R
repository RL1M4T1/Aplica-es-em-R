...
predicaoLM = predict(ENADE2019_PRODUCAO_LM, testeENADE)

postResample(testeENADE[ , 4], predicaoLM)

save(ENADE2019_PRODUCAO_LM, file = "D:/Repositorio_R/Aplica-es-em-R/scripts/transformacao/ENADE.RData") # salvar e exportar modelos
